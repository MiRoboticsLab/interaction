...
void DefineMotion(py::object m)
{
  ...
  .def_readonly(
    "params", &VPA::Motion::params_, R"pbdoc( 运动参数 )pbdoc")
  .def_readonly(
    "motion_id", &VPA::Motion::motion_id_, R"pbdoc( 运动ID )pbdoc")

  .def(
    "request",
    &VPA::Motion::Request, R"pbdoc( 请求 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::emergency_stop,
    py::arg("duration") = 0)

  .def(
    "emergency_stop",
    &VPA::Motion::Request, R"pbdoc( 急停 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::emergency_stop,
    py::arg("duration") = 0)

  .def(
    "get_down",
    &VPA::Motion::Request, R"pbdoc( 趴下 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::get_down,
    py::arg("duration") = 0)

  .def(
    "resume_standing",
    &VPA::Motion::Request, R"pbdoc( 恢复站立 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::resume_standing,
    py::arg("duration") = 0)

  .def(
    "back_flip",
    &VPA::Motion::Request, R"pbdoc( 后空翻 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::back_flip,
    py::arg("duration") = 0)

  .def(
    "front_flip",
    &VPA::Motion::Request, R"pbdoc( 前空翻 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::front_flip,
    py::arg("duration") = 0)

  .def(
    "bow",
    &VPA::Motion::Request, R"pbdoc( 作揖 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::bow,
    py::arg("duration") = 0)

  .def(
    "roll_left",
    &VPA::Motion::Request, R"pbdoc( 向左侧躺后恢复 )pbdoc",
    py::arg("motion_id") = VPA::MotionId::roll_left,
    py::arg("duration") = 0)

  .def(
    "walk_the_dog",
    &VPA::Motion::WalkTheDog, R"pbdoc( 遛狗 )pbdoc",
  ...
  .def(
    ...
    &VPA::Motion::RelativelyForceControlAttitude, R"pbdoc( 相对力控姿态 )pbdoc",
  ...
  .def(
    "transition_standing",
    &VPA::Motion::AbsolutePositionControlAttitude, R"pbdoc( 绝对位控姿态（过渡站立） )pbdoc",
    py::arg("centroid_z") = VPA::motion_params_.centroid_z.default_value,
    py::arg("duration") = 1
  )
  ...
  .def(
    ...
    &VPA::Motion::RelativelyPositionControlAttitude, R"pbdoc( 相对位控姿态 )pbdoc",
    py::arg("centroid_x") = VPA::motion_params_.centroid_x.default_value,
    py::arg("centroid_y") = VPA::motion_params_.centroid_y.default_value,
    py::arg("centroid_z") = VPA::motion_params_.centroid_z.default_value,
    py::arg("roll") = VPA::motion_params_.roll.default_value,
  ...
  .def(
    "jump_back_and_forth",
    &VPA::Motion::JumpBackAndForth, R"pbdoc( 前后跳 )pbdoc",
  ...
  .def(
    "small_jump_walking",
    &VPA::Motion::SmallJumpWalking, R"pbdoc( 小跳行走 )pbdoc",
    py::arg("x_velocity") = VPA::motion_params_.x_velocity.default_value,
    py::arg("y_velocity") = VPA::motion_params_.y_velocity.default_value,
    py::arg("z_velocity") = VPA::motion_params_.z_velocity.default_value,
    py::arg("front_leg_lift") = VPA::motion_params_.front_leg_lift.default_value,
  ...
  .def(
    "trot_walking",
    &VPA::Motion::TrotWalking, R"pbdoc( 小跑行走 )pbdoc",
    py::arg("x_velocity") = VPA::motion_params_.x_velocity.default_value,
    py::arg("y_velocity") = VPA::motion_params_.y_velocity.default_value,
    py::arg("z_velocity") = VPA::motion_params_.z_velocity.default_value,
    py::arg("front_leg_lift") = VPA::motion_params_.front_leg_lift.default_value,
  ...
  .def(
    ...
    &VPA::Motion::AutomaticFrequencyConversionWalking, R"pbdoc( 自动变频行走 )pbdoc",
    py::arg("x_velocity") = VPA::motion_params_.x_velocity.default_value,
    py::arg("y_velocity") = VPA::motion_params_.y_velocity.default_value,
    py::arg("z_velocity") = VPA::motion_params_.z_velocity.default_value,
    py::arg("front_leg_lift") = VPA::motion_params_.front_leg_lift.default_value,
  ...
  .def(
    "run_fast_walking",
    &VPA::Motion::RunFastWalking, R"pbdoc( 快跑行走 )pbdoc",
    py::arg("x_velocity") = VPA::motion_params_.x_velocity.default_value,
    py::arg("y_velocity") = VPA::motion_params_.y_velocity.default_value,
    py::arg("z_velocity") = VPA::motion_params_.z_velocity.default_value,
    py::arg("front_leg_lift") = VPA::motion_params_.front_leg_lift.default_value,
  ...
  .def(
    "turn",
    &VPA::Motion::Turn, R"pbdoc( 转向 )pbdoc",
    py::arg("angle") = 1,
    py::arg("duration") = 1
  )
  ...
  .def(
    "go_straight",
    &VPA::Motion::GoStraight, R"pbdoc( 直行 )pbdoc",
  ...
  .def(
    "lateral_movement",
    &VPA::Motion::LateralMovement, R"pbdoc( 横移 )pbdoc",
  ...
  .def(
    "run_sequence",
    &VPA::Motion::RunSequence, R"pbdoc( 运行序列 )pbdoc",
    py::arg("sequence")
  )

  .def(
    "choreographer",
    py::overload_cast<const std::string, const py::args>(&VPA::Motion::Choreographer),
    R"pbdoc( 运行序列 )pbdoc"
  )

  .def(
    "choreographer",
    py::overload_cast<const py::kwargs>(&VPA::Motion::Choreographer),
    R"pbdoc( 运行序列 )pbdoc"
  )
