...
from mi.cyberdog_vp.utils import get_terminal_header
...
c.InteractiveShellApp.exec_lines = [
    'print("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")',
    'print("┃ Cyberdog protocol version is 0.2.1.                                        ┃")',
    'print("┃ Use cyberdog.interface to view protocol interface document.                ┃")',
    'print("┠───┬────────────────────────┬───────────────────────────────────────────────┨")',
    'print("┃num│   protocol template    │                protocol description           ┃")',
    'print("┠───┼────────────────────────┼───────────────────────────────────────────────┨")',
    'print("┃ 1 │ visual.interface*      │ View protocol interface document entry.       ┃")',
    'print("┃ 2 │ visual.interface*.help │ View the help info for the current module.    ┃")',
    'print("┃ 3 │ visual.interface*.list │ View the protocol list of the current module. ┃")',
    'print("┃ 4 │ visual.interface*.tree │ View the protocol tree of the current module. ┃")',
    'print("┗━━━┷━━━━━━━━━━━━━━━━━━━━━━━━┷━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")',
]
c.InteractiveShellApp.exec_lines += get_terminal_header('True', 'default', 'all')

# for data in c.InteractiveShellApp.exec_lines:
#     print('data = ', data)
...
#                   'pyglet', 'qt', 'qt4', 'qt5', 'qt6', 'tk', 'wx', 'gtk2',
#                   'qt4'] (case-insensitive) or None
#  Default: None
...
#  Choices: any of ['auto', 'agg', 'gtk', 'gtk3', 'gtk4', 'inline', 'ipympl', 'nbagg',
#                   'notebook', 'osx', 'pdf', 'ps', 'qt', 'qt4', 'qt5', 'qt6', 'svg',
#                   'tk', 'widget', 'wx'] (case-insensitive) or None
#  Default: None
...
c.TerminalIPythonApp.display_banner = False  # 是否在启动 IPython 时显示横幅(Python 信息等)
...
c.InteractiveShell.colors = 'Linux'  # NoColor Neutral Linux 或 LightBG
...
c.InteractiveShell.confirm_exit = False  # 是否在退出 IPython 时显示确认(选择 [y]/n)
