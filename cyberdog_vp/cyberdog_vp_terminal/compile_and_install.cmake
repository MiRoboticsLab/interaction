...
function(compile_and_install_node)
  ...
  file(GLOB_RECURSE _node_file_list RELATIVE ${PROJECT_SOURCE_DIR} src/node/*.cpp)  # 以相对路径方式递归包含目标文件
...
function(compile_and_install_api)
  cmake_parse_arguments(_ARG "LOG" "" "" ${ARGN})
  if(_${PROJECT_NAME}_AMENT_PACKAGE)
    message(FATAL_ERROR "compile_and_install_api() Must be called before ament_package().")
  endif()
  if(_ARG_LOG)
