...
#ifndef CYBERDOG_AUDIO__READY_SN_HPP_
#define CYBERDOG_AUDIO__READY_SN_HPP_
...
public:
  ...
  : dog_sn("")
  {
    ready_sn_node_ = rclcpp::Node::make_shared("audio_get_dogsn");
    sn_notify_sub_ =
...
private:
  ...
  bool GetDogsn()
  {
    ...
    if (!audio_sn_ger_srv_->wait_for_service(std::chrono::seconds(1))) {
...
#endif  // CYBERDOG_AUDIO__READY_SN_HPP_
